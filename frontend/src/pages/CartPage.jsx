...
const CartPage = () => {
  // Get cart and savedForLater from the store
  const { cart, savedForLater } = useCartStore();
      ...
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
          ...
          >
            ...
            {/* Render Saved For Later below People Also Bought */}
            {savedForLater && savedForLater.length > 0 && <SavedForLater />}
          </motion.div>
